...
public interface TemplateService {
    ...
    /**
     * Replaces placeholders in an HTML string with values from a Profile object.
     *
     * @param html The HTML string to replace placeholders in.
     * @param profile The Profile object containing the values for replacement.
     * @return The updated HTML string with the placeholders replaced by the corresponding values.
     */
    String replacePlaceholder(String html, Profile profile);
